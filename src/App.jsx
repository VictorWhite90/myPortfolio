...
import { Moon, Sun, Menu, X, ExternalLink, Github, Linkedin, Twitter } from 'lucide-react';
...
const Portfolio = () => {
  ...
  image: prestineApart,
  stack: ['html5', ' CSS', 'Bootstrap', 'Emailjs', 'JS'],
  ...
  const experiences = [
    ...
    },
    {
      ...
      description: 'Developed and maintained the frontend of the RCCG “Advance” event platform using React and Tailwind CSS. Implemented responsive layouts, authentication interfaces, and payment integration to ensure a smooth user experience. Collaborated with the backend team to integrate APIs and deliver a fully functional, user-friendly application.'
    },
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      alert('Form submitted successfully! (EmailJS integration placeholder)');
            ...
            <div className="container mx-auto px-6 py-4 flex flex-col gap-4">
              {['Home', 'About', 'Skills', 'Projects', 'Experience', 'Contact'].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollToSection(item.toLowerCase())}
                  className="text-left text-gray-700 dark:text-gray-300 hover:text-cyan-500 dark:hover:text-cyan-400 transition-colors"
                >
                  {item}
                </button>
              ))}
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="flex-1 text-center md:text-left">
                ...
                <h2 className="text-3xl md:text-4xl font-semibold text-cyan-500 dark:text-cyan-400 mb-6">
                ...
                <button
                  ...
                  className="px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-white rounded-lg font-semibold transition-all transform hover:scale-105 shadow-lg"
                >
                  View My Work
                </button>
              </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8">
              {skills.map((skill, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center gap-3 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-xl transform hover:scale-110 transition-all duration-300"
                >
                  <img
                    src={skill.icon}
                    alt={`${skill.name} logo`}
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {projects.map((project, index) => (
                <article
                  key={index}
                  className="bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300"
                >
                  <img
                    src={project.image}
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                <div
                  key={index}
                  className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-xl transition-all duration-300 border-l-4 border-cyan-500"
                >
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="space-y-6 mb-12">
              <div>
                ...
                <input
                  ...
                  } text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500`}
              ...
              <div>
                ...
                <textarea
                  ...
                  } text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 resize-none`}
              ...
              <button
                ...
                className="w-full px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-white rounded-lg font-semibold transition-all transform hover:scale-105 shadow-lg"
              >
                Send Message
              </button>
            </div>
            <div className="flex justify-center gap-6">
              <a
                ...
                className="p-4 bg-gray-200 dark:bg-gray-700 hover:bg-cyan-500 dark:hover:bg-cyan-500 rounded-full transition-all transform hover:scale-110"
              ...
              >
                <Twitter className="w-6 h-6 text-gray-700 dark:text-white" />
              </a>
            </div>
          </div>
        </section>
